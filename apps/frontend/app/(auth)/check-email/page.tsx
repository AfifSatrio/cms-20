...
export default async function CheckEmailPage({
  ...
  const email = params.email ?? "uremail@gmail.com";
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100 dark:bg-zinc-900">
      <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-lg dark:bg-zinc-800">
        ...
        <p className="mb-8 mt-4 text-sm text-gray-600 dark:text-gray-300">
          ...
          ) which valid for 24 hours. Please check your inbox!
        </p>
        ...
        <a
          ...
          className="mt-6 flex w-full items-center justify-center rounded-lg bg-green-700 py-3 font-semibold text-white hover:bg-green-800"
        >
          Open Gmail
        </a>
        ...
        <a
          href="/login"
          className="mt-4 inline-flex items-center justify-center gap-2 text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-300"
        >
