      ...
      <div className="px-8 mt-10 pb-20">
        <div className="bg-gray-200 rounded-xl p-10 max-w-4xl">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-6">
            The content builder allows you to visually create and structure your page
            using flexible and customizable components.
          </p>

          <ul className="space-y-4 text-sm text-gray-700">
            <li>
              <p className="font-semibold">• Single Page</p>
              <p className="ml-4 mt-1">
                Create and structure a single page layout visually.
              </p>
            </li>

            <li>
              <p className="font-semibold">• Multiple Page</p>
              <p className="ml-4 mt-1">
                Manage multiple pages with reusable components.
              </p>
            </li>
